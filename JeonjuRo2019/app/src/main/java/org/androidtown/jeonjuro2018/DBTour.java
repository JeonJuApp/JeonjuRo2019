...
public class DBTour {
    ...
    public void load()
    {
        ...
        {
            SplashActivity.dbHelper.insert("Tour", tourInfoArrayList.get(i).getTourName(), tourInfoArrayList.get(i).getTourLocation(), null, tourInfoArrayList.get(i).getDataContent(), tourDataList.get(i).getPosx(), tourDataList.get(i).getPosy(), tourInfoArrayList.get(i).getHomepage(), null, null, null, null, null, tourInfoArrayList.get(i).getUrl());
        }

        Log.i("리얼리얼", SplashActivity.dbHelper.getResult());
    }
